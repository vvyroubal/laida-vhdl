-- BCD to 7-segment decoder (common-cathode, active-high segments).
-- Input: 4-bit BCD digit (0..9). Inputs 10..15 produce blank output.
-- Output: seg(6 downto 0) = a, b, c, d, e, f, g.
...
begin
    ...
    begin
        case bcd is
            ...
            when others => seg <= "0000000";  -- invalid BCD: blank
        end case;
    end process;
end architecture;
